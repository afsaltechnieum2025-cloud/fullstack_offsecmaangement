    ...
    <>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', width: '100%' }}>
            ...
            <div style={{
              ...
              <span>INITIALIZING STATIC ANALYSIS ENGINE</span>
              <span style={{
          ...
          <div style={{
            ...
            {['TAINT ANALYSIS', 'CODE SCANNING', 'VULN DETECT', 'AST PARSING', 'DATA FLOW'].map((t, i) => (
              <div key={t} style={{
                fontFamily: "'Courier New', monospace",
          ...
          <div style={{
            ...
            {['SEMGREP', 'SONARQUBE', 'CODEQL', 'BANDIT', 'CHECKMARX'].map((t, i) => (
              <div key={t} style={{
                fontFamily: "'Courier New', monospace",
                fontSize: 'clamp(7px, 1.2vw, 9px)',
                color: 'rgba(249,115,22,0.25)',
      ...
      {!loading && (
        <div style={{
          ...
          <div style={{
            position: 'absolute', inset: 0,
            background: 'radial-gradient(ellipse 75% 65% at 50% 50%, transparent 35%, rgba(7,8,13,0.9) 100%)',
          }} />

          {/* Ambient glow */}
          <div style={{
            position: 'absolute',
            width: 'min(800px, 100vw)', height: 'min(500px, 70vh)',
            background: 'radial-gradient(ellipse, rgba(249,115,22,0.06) 0%, transparent 70%)',
          }} />

          {/* Corner brackets */}
          {([
            { top: 'clamp(20px,4vw,40px)',    left:  'clamp(20px,4vw,40px)',  borderTop: '1.5px solid rgba(249,115,22,0.35)', borderLeft:  '1.5px solid rgba(249,115,22,0.35)' },
            { top: 'clamp(20px,4vw,40px)',    right: 'clamp(20px,4vw,40px)', borderTop: '1.5px solid rgba(249,115,22,0.35)', borderRight: '1.5px solid rgba(249,115,22,0.35)' },
            { bottom: 'clamp(20px,4vw,40px)', left:  'clamp(20px,4vw,40px)', borderBottom: '1.5px solid rgba(249,115,22,0.35)', borderLeft:  '1.5px solid rgba(249,115,22,0.35)' },
            { bottom: 'clamp(20px,4vw,40px)', right: 'clamp(20px,4vw,40px)', borderBottom: '1.5px solid rgba(249,115,22,0.35)', borderRight: '1.5px solid rgba(249,115,22,0.35)' },
          ] as React.CSSProperties[]).map((style, i) => (
            <div key={i} style={{
              position: 'absolute', zIndex: 10,
              width: 'clamp(24px, 4vw, 40px)', height: 'clamp(24px, 4vw, 40px)',
          ...
          {/* Main content */}
          <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', maxWidth: '720px', padding: '0 clamp(24px, 6vw, 48px)' }}>

            {/* Eyebrow */}
            <div style={{
              fontSize: 'clamp(9px, 1.8vw, 11px)', letterSpacing: '0.45em',
            ...
            <div style={{
              ...
              filter: 'drop-shadow(0 0 40px rgba(249,115,22,0.4)) drop-shadow(0 0 80px rgba(249,115,22,0.15))',
              marginBottom: 'clamp(8px, 2vw, 14px)',
            }}>SAST</div>

            {/* Full name */}
            <div style={{
              fontSize: 'clamp(10px, 2vw, 14px)', letterSpacing: '0.3em',
              color: 'rgba(249,115,22,0.7)', marginBottom: 'clamp(6px, 1.5vw, 10px)',
              fontWeight: 600,
            }}>
              STATIC APPLICATION SECURITY TESTING
            </div>
            ...
            <div style={{
              ...
              color: 'rgba(249,115,22,0.35)', marginBottom: 'clamp(28px, 6vw, 44px)',
              lineHeight: 1.7,
            }}>
            ...
            <div style={{
              ...
              {['Code Scanning', 'Vulnerability Detection', 'Taint Analysis', 'Dependency Audit', 'OWASP Mapping', 'CI/CD Integration', 'AST Parsing', 'Data Flow Analysis'].map(feat => (
                <div key={feat} style={{
