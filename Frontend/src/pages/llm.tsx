      ...
      {loading && (
        <div style={{
          ...
          <div style={{
            ...
            {['PROMPT INJECT', 'JAILBREAK', 'RAG POISON', 'TOKEN LEAK', 'EMBEDDING'].map((t, i) => (
              <div key={t} style={{
                fontFamily: "'Courier New', monospace",
          ...
          <div style={{
            ...
            {['GPT-4o', 'CLAUDE 3', 'GEMINI', 'MISTRAL', 'LLAMA 3'].map((t, i) => (
              <div key={t} style={{
                fontFamily: "'Courier New', monospace",
                fontSize: 'clamp(7px, 1.2vw, 9px)',
                color: 'rgba(249,115,22,0.25)',
