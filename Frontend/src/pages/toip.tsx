        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', width: '100%' }}>
            ...
            <div style={{
              ...
              TECHNIEUM &nbsp;/&nbsp; OFFENSIVE INTELLIGENCE
            </div>
            ...
            <div style={{
              ...
              <span>LOADING INTELLIGENCE PORTAL</span>
              <span style={{
          ...
          <div style={{
            ...
            {['IOC CORRELATE', 'TTP MAPPING', 'DARK WEB MON', 'CVE INTEL', 'THREAT ACTOR'].map((t, i) => (
              <div key={t} style={{
                fontFamily: "'Courier New', monospace",
          ...
          <div style={{
            ...
            {['ADVERSARY TRACK', 'EXPLOIT INTEL', 'MITRE ATT&CK', 'OSINT FEED', 'PLAYBOOKS'].map((t, i) => (
              <div key={t} style={{
                fontFamily: "'Courier New', monospace",
                fontSize: 'clamp(7px, 1.2vw, 9px)',
                color: 'rgba(249,115,22,0.25)',
