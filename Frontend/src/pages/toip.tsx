      ...
      {loading && (
        ...
        >
          ...
          <div style={{
            ...
            borderRadius: '50%',
            animation: 'toipPulse 2s ease-in-out infinite',
          }} />
          ...
          <div style={{ position: 'relative', textAlign: 'center', padding: '0 clamp(16px, 5vw, 32px)' }}>
            ...
            }}>LOADING INTELLIGENCE PORTAL...</div>
          </div>
          ...
          <style>{`
            ...
            @keyframes toipPulse { 0%, 100% { opacity: 1; transform: scale(1); } 50% { opacity: 0.6; transform: scale(1.05); } }
